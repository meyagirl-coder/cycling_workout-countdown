...
const VALID_URL = 'https://whatsonzwift.com/workouts/threshold/over-unders';
...
describe('api/whatsonzwift-workout handler', () => {
  ...
  it('maps a 403 from WhatsOnZwift to a 502 with an anti-bot-specific message (not the generic HTTP 403 message)', async () => {
